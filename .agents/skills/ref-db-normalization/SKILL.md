...
- Treat 4NF and beyond as specialized cases, not routine application design targets.
...
- 4NF and higher address rarer multivalued or join-dependency cases and are usually unnecessary for routine OLTP work.

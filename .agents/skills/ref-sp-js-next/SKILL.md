...
- Use `.agents/skills/ref-sp-js-react-next/SKILL.md` when the user is planning or reviewing a whole React and Next app rather than one framework concern.
...
- Use `.agents/skills/ref-sp-js-web-standalone/SKILL.md` when the requirement is a browser-only app that should stay framework-free and no-build by default.

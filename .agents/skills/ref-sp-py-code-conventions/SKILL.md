---
name: ref-sp-py-code-conventions
...
- Use `.agents/skills/ref-sp-py-python/SKILL.md` for portable Python structure, typing, and CLI guidance.
- Use `.agents/skills/ref-sp-dev-coding-patterns/SKILL.md` for language-agnostic naming, control-flow, comment, and testing defaults.
- Use `.agents/skills/ref-sp-dev-project-setup/SKILL.md` for top-level repo wiring such as `pyproject.toml`, `.agents/skills/`, and `scripts/`.

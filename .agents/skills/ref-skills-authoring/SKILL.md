...
- **Name tool skills as actions:** A `tool-...` skill should read like an action connected to its purpose, such as `tool-adopt-these-skills` or `tool-maintain-skills`, not like a passive topic label.

...
- For repo instruction files (`.github/copilot-instructions.md`, `GEMINI.md`, `.claude/CLAUDE.md`), use `.agents/skills/ref-agents-instructions-authoring/SKILL.md`.
- When a hook reads or guards protected/secret files, use `.agents/skills/ref-agents-security/SKILL.md`.
...
- Read `.agents/skills/ref-agents-security/SKILL.md` when a hook touches protected files, secrets, or exclusion rules.

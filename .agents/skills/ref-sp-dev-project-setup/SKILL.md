...
- Use `.agents/skills/ref-sp-dev-projects-architecture/SKILL.md` for portable structure patterns such as feature-first organization, shared-utility thresholds, and product-vs-maintenance boundaries.
- Use `.agents/skills/ref-sp-py-python/SKILL.md` for Python-specific feature layouts such as `src/<package>/<feature>/`.
- Use `.agents/skills/ref-sp-js-javascript/SKILL.md` and `.agents/skills/ref-sp-js-typescript/SKILL.md` for language-specific JS or TS guidance, including package-level layout and monorepo-friendly paths like `packages/<package-name>/src/<feature>/` when that style fits the repo.
...
| `src/agentic_tools/<feature>/` | Packaged feature code and its tests. For placement rules and feature-folder shape, defer to `.agents/skills/ref-sp-py-python/SKILL.md` and `.agents/skills/ref-sp-dev-projects-architecture/SKILL.md`. |
...
See .agents/skills/ref-sp-py-code-conventions/SKILL.md for typing rules.
...
| Should a new reusable parser live in a feature folder or a shared utility area? | `.agents/skills/ref-sp-dev-projects-architecture/SKILL.md` | That is a portable boundary decision. |
| Where should a new Python feature live? | `.agents/skills/ref-sp-py-python/SKILL.md` | Python feature layout belongs to the Python skill. |
| Should a new repo helper live in `scripts/` or under `src/agentic_tools/`? | This skill first, then `.agents/skills/ref-sp-dev-projects-architecture/SKILL.md` if the boundary is unclear | The top-level folder choice is repo-specific, but the product-vs-maintenance rule is architectural. |
...
| How should a TypeScript or JavaScript package be laid out in a monorepo? | `.agents/skills/ref-sp-js-typescript/SKILL.md` or `.agents/skills/ref-sp-js-javascript/SKILL.md` | That is language and package-layout guidance, not repo wiring. |
...
|----------|----------------|-----|
| Packaged Python feature | `src/agentic_tools/<feature>/` | Shipped behavior belongs under the package root; see `.agents/skills/ref-sp-py-python/SKILL.md` for the feature layout details. |
...
- .agents/skills/ref-sp-dev-projects-architecture/SKILL.md — Portable structure patterns, boundaries, and shared-utility rules
- .agents/skills/ref-sp-py-python/SKILL.md — Python feature layout, CLI placement, and testing patterns
- .agents/skills/ref-sp-js-javascript/SKILL.md — JavaScript structure and JSDoc guidance
- .agents/skills/ref-sp-js-typescript/SKILL.md — TypeScript layout and runtime-boundary guidance
- .agents/skills/ref-sp-agents-persona/SKILL.md — Agent persona and workflow expectations

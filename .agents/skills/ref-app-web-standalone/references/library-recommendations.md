...
- Do not pull in React or a full framework just to make a browser app feel more app-like; if the problem truly crossed that boundary, move to `.agents/skills/ref-app-react-next/SKILL.md`.

...
- Use `.agents/skills/ref-next/SKILL.md` when the main question is about App Router, routing, client or server component boundaries, metadata, or other Next.js-specific integrations.
- Use `.agents/skills/ref-typescript/SKILL.md` when the main question is about strict type modeling, runtime trust boundaries, or `tsconfig` design rather than React behavior.
- Use `.agents/skills/ref-javascript/SKILL.md` when the code intentionally stays plain JavaScript with JSDoc and the main question is not React-specific.

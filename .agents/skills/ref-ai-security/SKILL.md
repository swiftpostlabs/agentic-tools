...
description: "Reference guidance for AI policy, protected file access, exclusion sync, and multi-client enforcement. Use when: modifying a policy source file, updating the sync workflow, reviewing generated restriction files, or changing how agents are prevented from reading sensitive files."
metadata:
...
If you are working in this repository specifically, use `.agents/skills/ref-swiftpost-ai-policy/SKILL.md` for the concrete `.agents/policy.json`, `agents-policy`, and generated-file implementation.
...
- Read `.agents/skills/ref-swiftpost-ai-policy/SKILL.md` when you need this repository's concrete policy file location, command names, service-selection model, or generated output details.

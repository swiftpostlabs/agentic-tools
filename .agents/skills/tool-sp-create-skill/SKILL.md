...
- Set `metadata.agentic-tools-category` to the skill's domain category. Use `.agents/skills/ref-sp-agents-categories/SKILL.md` for this repo's current taxonomy and do not create organization categories merely because a skill name is repo-specific.

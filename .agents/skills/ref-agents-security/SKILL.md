...
- Read `.agents/skills/ref-swiftpost-agents-policy/SKILL.md` when you need this repository's concrete policy file location, command names, service-selection model, or generated output details.

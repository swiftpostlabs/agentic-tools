...
4. Prefer `.agents/skills.json` plus `uv run agentic-tools skills sync` when the target repo should keep tracking this repo as the source.
...
- The suggested `.agents/skills.json` block or grouped `agentic-tools skills ...` commands.

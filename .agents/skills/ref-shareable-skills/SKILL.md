...
.agents/skills/ref-skills-authoring/SKILL.md. The two are complementary and independent; neither
...
owned by ref-skills-authoring (`validate-skill.mts`). Run both when a skill should be good *and*
shareable.
...
- .agents/skills/ref-skills-authoring/SKILL.md — general skill-quality authoring (complementary).
- .agents/skills/tool-make-skill-shareable/SKILL.md — guided shareability decision for a skill.

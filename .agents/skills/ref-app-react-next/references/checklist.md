...
- React component internals and dependency choices are delegated to `ref-js-react` instead of duplicated here.
- Next.js rendering, routing, and integration rules are delegated to `ref-js-next` instead of duplicated here.

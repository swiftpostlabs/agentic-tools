...
AGENTIC_TOOLS_REPO_URL = "https://github.com/swiftpostlab/agentic-tools"
...
def build_synced_skills_gitignore(skill_names: Collection[str]) -> str:
    lines = [
...
def write_synced_skills_gitignore(
    ...
    *,
    ...
    content = build_synced_skills_gitignore(skill_names)
